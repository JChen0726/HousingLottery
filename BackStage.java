...
public class BackStage {
    ...
    Hashtable<Dorms, ArrayList<Rooms>> dormDirect;

    BackStage(Hashtable<String, Student> studentProfile, Hashtable<Dorms, ArrayList<Rooms>> dormDirect){
        this.studentProfile = studentProfile;
        this.dormDirect = dormDirect;
    }
